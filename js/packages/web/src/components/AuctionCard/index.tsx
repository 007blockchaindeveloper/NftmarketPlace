...
export const AuctionCard = ({
  ...
  const [showAndroidARQRCode, setShowAndroidARQRCode] = useState(false);
  const [showIOSARQRCode, setShowIOSARQRCode] = useState(false);
  ...
  return (
    <div className="auction-container" style={style}>
      ...
      <MetaplexModal
        visible={showAndroidARQRCode}
        onCancel={() => setShowAndroidARQRCode(false)}
        bodyStyle={{
          alignItems: 'start',
        }}
      >
        <h3 style={{ color: 'white' }}>
          Scan the following QR Code in your AR-Capable Android phone
          <a href={androidARURL}>&nbsp;or use this link.</a>
        </h3>
        <br />
        <QRCode value={androidARURL} />
      </MetaplexModal>

      <MetaplexModal
        visible={showIOSARQRCode}
        onCancel={() => setShowIOSARQRCode(false)}
        bodyStyle={{
          alignItems: 'start',
        }}
      >
        <h3 style={{ color: 'white' }}>
          Scan the following QR Code in your AR-Capable iOS phone
          <a href={iOSARURL}>&nbsp;or use this link.</a>
        </h3>
        <QRCode value={iOSARURL} />
      </MetaplexModal>
    </div>
  );
};
